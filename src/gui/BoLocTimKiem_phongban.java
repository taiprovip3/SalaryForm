 ...
 * @author taiproduaxe
 */
public class BoLocTimKiem_phongban extends javax.swing.JFrame {

    /**
     * Creates new form BoLocTimKiem_phongban
     */
    public BoLocTimKiem_phongban() {
        initComponents();
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã phòng ban", "Tên phòng ban", "Vị trí", "Số lượng NV", "Người đại diện", "Nghiệp vụ"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BoLocTimKiem_phongban.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BoLocTimKiem_phongban().setVisible(true);
            }
        });
    }
